...
void MELAtemplate(char* channel="4mu",bool lowMass=true,bool plotSmooth=true){
  ...
  //sprintf(fileName,"../datafiles/Dsignal_ALT_%s.root",channel);
  ...
  if(lowMass){
    sigTemplate->GetXaxis()->SetRangeUser(100,179.9);
    //sigPsTemplate->GetXaxis()->SetRangeUser(100,179.9);
    qqZZTemplate->GetXaxis()->SetRangeUser(100,179.9);
    ggZZTemplate->GetXaxis()->SetRangeUser(100,179.9);
  }else{
...
void measureSystematics(double mzzLow=130, double mzzHigh=180){
  ...
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleMu_CREEEEssTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleMu_CRMMMMssTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleMu_CREEMMssTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleMu_CRMMEEssTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleMu_CREEEEosTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleMu_CRMMMMosTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleMu_CREEMMosTree.root");

  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleOr_CREEEEssTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleOr_CRMMMMssTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleOr_CREEMMssTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleOr_CRMMEEssTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleOr_CREEEEosTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleOr_CRMMMMosTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleOr_CREEMMosTree.root");

  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleEle_CREEEEssTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleEle_CRMMMMssTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleEle_CREEMMssTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleEle_CRMMEEssTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleEle_CREEEEosTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleEle_CRMMMMosTree.root");
  CRdata->Add("CJLSTtrees_June21_2012/7TeV_FSR/CR/HZZ4lTree_DoubleEle_CREEMMosTree.root");
  ...
  CRmc->SetBranchAddress("ZZpseudoLD",&D);  
  CRmc->SetBranchAddress("ZZLD",&mela);
  CRmc->SetBranchAddress("MC_weight",&w);

  CRdata->SetBranchAddress("ZZMass",&mzz);
  CRdata->SetBranchAddress("ZZpseudoLD",&D);
  CRdata->SetBranchAddress("ZZLD",&mela);

  
  qqZZ->SetBranchAddress("ZZMass",&mzz);
  qqZZ->SetBranchAddress("ZZpseudoLD",&D);
  qqZZ->SetBranchAddress("ZZLD",&mela);
  ...
  for(int iEvt=0; iEvt<qqZZ->GetEntries(); iEvt++){
    ...
    if(mzz>mzzLow&&mzz<mzzHigh && mela>.5){
      h_qqZZ->Fill(D,w);
    }
